...
// const List<String> status_string = ["Appcolors.green", Appcolors.yelloww, Appcolors.yellow];
const List<Color> colors = [Appcolors.bleu, Appcolors.yelloww, Appcolors.green];
