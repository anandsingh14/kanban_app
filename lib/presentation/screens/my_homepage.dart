                          ...
                          return snapshot.data!.isNotEmpty
                              ? ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    var task1=snapshot.data![index];
                                    var task;
                                    if (filterList == task1.status) {
                                      task = snapshot.data![index];
                                      Widget _taskcontainer = TaskContainer(
                                        id: task.id,
                                        color: colors[task.status - 1],
                                        title: task.title,
  ...
  SizedBox _buildDatePicker(
    ...
    return SizedBox(
      ...
      child: DatePicker(
        ...
        dateTextStyle:
            Theme.of(context).textTheme.headline1!.copyWith(fontSize: 10.sp),
        dayTextStyle: Theme.of(context)
            .textTheme
            .subtitle1!
            .copyWith(fontSize: 5.sp, color: Appcolors.black),
        monthTextStyle: Theme.of(context)
            .textTheme
            .subtitle1!
            .copyWith(fontSize: 5.sp, color: Appcolors.black),
        selectionColor: Appcolors.inoscripta,
