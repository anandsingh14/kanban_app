...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  List<DropdownMenuItem<int>> statusItems = const [
    DropdownMenuItem(
        child: Text(
          "TO DO",
        ),
  ...
  void initState() {
    ...
    _selectedstatus = isEditMote ? widget.task!.status : 1;
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
                      ...
                      ontap: () {
                        Navigator.push(
                            ...
                            showPicker(
                              value: _starthour,
                              is24HrFormat: true,
                              accentColor: Appcolors.inoscripta,
          ...
          _buildstatusDropdownButton(context),
          ...
          Row(
            ...
            children: [
              ...
              // ),
              MyButton(
                color: isEditMote ? Colors.green : Appcolors.inoscripta,
                width: 40.w,
  ...
  DropdownButtonFormField<int> _buildstatusDropdownButton(BuildContext context) {
    return DropdownButtonFormField(
      ...
      style: Theme.of(context)
          .textTheme
          .headline1!
          .copyWith(fontSize: 9.sp, color: Appcolors.inoscripta),
      icon: Icon(
        Icons.arrow_drop_down,
        color: Appcolors.inoscripta,
        size: 25.sp,
      ),
